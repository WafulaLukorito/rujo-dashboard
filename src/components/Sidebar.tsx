...
import { Home, Music, Activity, Settings, Disc3 } from 'lucide-react';
  ...
  return (
    <div className="w-72 bg-[#0d1117] border-r border-[#1f2937] text-gray-300 h-screen fixed top-0 left-0 flex flex-col pt-8 pb-4">
      ...
      <nav className="flex-1 px-4 space-y-2">
        <Link href="/" className="flex items-center space-x-3 px-4 py-3 rounded-xl bg-[#1f2937]/50 text-indigo-400 font-medium border border-[#374151]/50 shadow-sm transition-all hover:shadow-indigo-500/10">
          <Home className="h-5 w-5" />
          <span>Overview</span>
        </Link>
        <Link href="/catalog" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-[#1f2937]/30 transition-all font-medium hover:text-white">
